...
const QuestionForm = ({ question }: { question?: any }) => {
    ...
    const update = async () => {
        ...
        const attachmentId = await (async () => {
            ...
            await storage.deleteFile({ bucketId: questionAttachmentBucket, fileId: question.attachmentId });
        ...
        <form className="space-y-4" onSubmit={submit}>
            ...
            <LabelInputContainer>
                ...
                <div className="mt-4 flex w-full items-center justify-center">
                    <Label
                        htmlFor="image"
                        className="relative flex h-64 w-full cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-neutral-300 bg-neutral-50 hover:bg-neutral-100 dark:border-neutral-600 dark:bg-slate-900 dark:hover:border-neutral-500 dark:hover:bg-slate-800"
                    >
